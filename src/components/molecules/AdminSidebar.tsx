      ...
      >
        ...
        <div className="px-3 py-4 border-t border-gray-100 dark:border-gray-800 space-y-1">
          ...
          <button
            ...
            disabled={loggingOut}
            className="w-full flex items-center gap-3 rounded-xl px-3.5 py-2.5 text-sm font-medium text-red-500 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors disabled:opacity-50"
          >
            <LogOut size={18} />
