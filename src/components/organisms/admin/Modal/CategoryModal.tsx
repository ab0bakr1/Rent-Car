...
import type { Category, CategoryFormData } from "@/utils/categories-service";

export type CategoryModalMode = "add" | "edit" | null;
...
const EMPTY_FORM: CategoryFormData = { name: "", icon: "" };

export default function CategoryModal({ mode, category, isLoading, onClose, onSubmit }: Props) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative z-10 w-full max-w-md rounded-2xl bg-white dark:bg-gray-900 p-8 shadow-2xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label className="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-300">
              أيقونة <span className="text-gray-400 font-normal">(اختياري، رابط أو اسم أيقونة)</span>
            </label>
            <input
              value={form.icon ?? ""}
